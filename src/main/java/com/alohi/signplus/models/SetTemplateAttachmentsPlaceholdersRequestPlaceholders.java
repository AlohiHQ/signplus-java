...
public class SetTemplateAttachmentsPlaceholdersRequestPlaceholders {
  ...
  public static class SetTemplateAttachmentsPlaceholdersRequestPlaceholdersBuilder {
    ...
    @JsonProperty("required")
    public SetTemplateAttachmentsPlaceholdersRequestPlaceholdersBuilder required(Boolean value) {
    ...
    @JsonProperty("multiple")
    public SetTemplateAttachmentsPlaceholdersRequestPlaceholdersBuilder multiple(Boolean value) {
