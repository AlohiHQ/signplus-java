...
@EqualsAndHashCode
@Jacksonized
public class ListTemplateDocumentAnnotationsResponse {
  ...
  public static class ListTemplateDocumentAnnotationsResponseBuilder {

    private JsonNullable<List<Annotation>> annotations = JsonNullable.undefined();

    @JsonProperty("annotations")
    public ListTemplateDocumentAnnotationsResponseBuilder annotations(List<Annotation> value) {
      if (value == null) {
