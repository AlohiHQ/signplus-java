...
public class ListTemplatesParameters {
  ...
  @JsonInclude(JsonInclude.Include.ALWAYS)
  private ListTemplatesRequest requestBody;

  // Overwrite lombok builder methods
  public static class ListTemplatesParametersBuilder {
    ...
    public ListTemplatesParametersBuilder accept(String accept) {
      this.accept$set = true;
      this.accept = accept;
      return this;
    }

    public ListTemplatesParametersBuilder requestBody(ListTemplatesRequest requestBody) {
      this.requestBody$set = true;
      this.requestBody = requestBody;
      return this;
    }

    public ListTemplatesParameters build() {
      if (!accept$set) {
      ...
      return new ListTemplatesParameters(accept, requestBody);
    }
  }
}
