...
public class AddEnvelopeAnnotationRequestDatetime {
  ...
  public static class AddEnvelopeAnnotationRequestDatetimeBuilder {
    ...
    @JsonProperty("size")
    public AddEnvelopeAnnotationRequestDatetimeBuilder size(String value) {
    ...
    @JsonProperty("auto_fill")
    public AddEnvelopeAnnotationRequestDatetimeBuilder autoFill(String value) {
    ...
    @JsonProperty("timestamp")
    public AddEnvelopeAnnotationRequestDatetimeBuilder timestamp(String value) {
