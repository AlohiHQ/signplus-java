...
public class TextFont2 {
  ...
  public static class TextFont2Builder {

    private JsonNullable<String> family = JsonNullable.undefined();

    @JsonProperty("family")
    public TextFont2Builder family(String value) {
    ...
    @JsonProperty("italic")
    public TextFont2Builder italic(Boolean value) {
    ...
    @JsonProperty("bold")
    public TextFont2Builder bold(Boolean value) {
