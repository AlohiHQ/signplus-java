...
public class AddTemplateAnnotationRequestCheckbox {
  ...
  private JsonNullable<String> checked;
  ...
  public static class AddTemplateAnnotationRequestCheckboxBuilder {
    ...
    private JsonNullable<String> checked = JsonNullable.undefined();

    @JsonProperty("checked")
    public AddTemplateAnnotationRequestCheckboxBuilder checked(String value) {
