...
@EqualsAndHashCode
@Jacksonized
public class SetTemplateAttachmentsSettingsRequestSettings {
  ...
  public static class SetTemplateAttachmentsSettingsRequestSettingsBuilder {

    private JsonNullable<Boolean> visibleToRecipients = JsonNullable.undefined();

    @JsonProperty("visible_to_recipients")
    public SetTemplateAttachmentsSettingsRequestSettingsBuilder visibleToRecipients(Boolean value) {
