...
@EqualsAndHashCode
@Jacksonized
public class ListEnvelopeDocumentAnnotationsResponse {
  ...
  public static class ListEnvelopeDocumentAnnotationsResponseBuilder {

    private JsonNullable<List<Annotation>> annotations = JsonNullable.undefined();

    @JsonProperty("annotations")
    public ListEnvelopeDocumentAnnotationsResponseBuilder annotations(List<Annotation> value) {
      if (value == null) {
