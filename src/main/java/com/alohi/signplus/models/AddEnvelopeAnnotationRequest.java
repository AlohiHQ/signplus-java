...
public class AddEnvelopeAnnotationRequest {
  ...
  public static class AddEnvelopeAnnotationRequestBuilder {
    ...
    @JsonProperty("page")
    public AddEnvelopeAnnotationRequestBuilder page(String value) {
    ...
    @JsonProperty("x")
    public AddEnvelopeAnnotationRequestBuilder x(String value) {
    ...
    @JsonProperty("y")
    public AddEnvelopeAnnotationRequestBuilder y(String value) {
    ...
    @JsonProperty("width")
    public AddEnvelopeAnnotationRequestBuilder width(String value) {
    ...
    @JsonProperty("height")
    public AddEnvelopeAnnotationRequestBuilder height(String value) {
    ...
    @JsonProperty("required")
    public AddEnvelopeAnnotationRequestBuilder required(String value) {
