...
@EqualsAndHashCode
@Jacksonized
public class ListEnvelopeDocumentsResponse {
  ...
  public static class ListEnvelopeDocumentsResponseBuilder {

    private JsonNullable<List<Document>> documents = JsonNullable.undefined();

    @JsonProperty("documents")
    public ListEnvelopeDocumentsResponseBuilder documents(List<Document> value) {
      if (value == null) {
