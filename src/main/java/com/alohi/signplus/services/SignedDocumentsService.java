...
/**
 * SignedDocumentsService Service
 */
public class SignedDocumentsService extends BaseService {

  private RequestConfig downloadEnvelopeSignedDocumentsConfig = RequestConfig.builder()
    .environment(Environment.RESTAPI)
    .build();

  /**
   * Constructs a new instance of SignedDocumentsService.
   *
   * @param httpClient The HTTP client to use for requests
   * @param config The SDK configuration
   */
  public SignedDocumentsService(@NonNull OkHttpClient httpClient, SignplusConfig config) {
   ...
   */
  public SignedDocumentsService setDownloadEnvelopeSignedDocumentsConfig(RequestConfig config) {
   ...
   */
  public Object downloadEnvelopeSignedDocuments(
   ...
   */
  public CompletableFuture<Object> downloadEnvelopeSignedDocumentsAsync(
    @NonNull String envelopeId,
    @NonNull DownloadEnvelopeSignedDocumentsParameters requestParameters
  ) throws ApiError {
