...
public class WebhooksService extends BaseService {
  ...
  private RequestConfig listWebhooksConfig = RequestConfig.builder()
    .environment(Environment.RESTAPI)
    .build();

  /**
   * Constructs a new instance of WebhooksService.
   *
   * @param httpClient The HTTP client to use for requests
   * @param config The SDK configuration
   */
  public WebhooksService(@NonNull OkHttpClient httpClient, SignplusConfig config) {
   ...
   */
  public WebhooksService setListWebhooksConfig(RequestConfig config) {
   ...
   */
  public Object listWebhooks(@NonNull ListWebhooksParameters requestParameters) throws ApiError {
    return this.listWebhooks(requestParameters, null);
  }
  ...
  public Object listWebhooks(
    ...
    Request request = this.buildListWebhooksRequest(requestParameters, resolvedConfig);
   ...
   */
  public CompletableFuture<Object> listWebhooksAsync(
    @NonNull ListWebhooksParameters requestParameters
  ) throws ApiError {
    return this.listWebhooksAsync(requestParameters, null);
  }
